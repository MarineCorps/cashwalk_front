...
class CommentService {
  static const String basePath = '/api/community/comments';

  /// ✅ 댓글 목록 조회
  static Future<List<dynamic>> fetchComments(int postId) async {
    final jwt = await JwtStorage.getToken();
    final url = Uri.parse('${HttpService.baseUrl}$basePath/post/$postId');
  ...
  static Future<void> updateComment(int commentId, String content) async {
    final jwt = await JwtStorage.getToken();
    final url = Uri.parse('${HttpService.baseUrl}$basePath/$commentId');
  ...
  static Future<void> toggleCommentReaction(int commentId, String type) async {
    final jwt = await JwtStorage.getToken();
    final url = Uri.parse('${HttpService.baseUrl}$basePath/comment/$commentId/$type');
  ...
  static Future<Map<String, int>> fetchCommentReactions(int commentId) async {
    final jwt = await JwtStorage.getToken();
    final url = Uri.parse('${HttpService.baseUrl}$basePath/$commentId/reactions');
  ...
  static Future<List<dynamic>> fetchMyComments() async {
    final jwt = await JwtStorage.getToken();
    final url = Uri.parse('${HttpService.baseUrl}/api/community/my-comments');
  ...
  static Future<List<dynamic>> fetchMyRepliedComments() async {
    final jwt = await JwtStorage.getToken();
    final url = Uri.parse('${HttpService.baseUrl}/api/community/my-replied-comments');
  ...
  static Future<void> reportComment(int commentId, String reasonCode) async {
    final jwt = await JwtStorage.getToken();
    final url = Uri.parse('${HttpService.baseUrl}/api/report');
